...
public class Demo {
    public static void main(String[] args) {
        System.out.println("##### Null Object Pattern: Problem Demo #####");
    ...
    private static void printVehicleDetails(Vehicle vehicle){
        if(vehicle != null){ // THE PROBLEM
            if(vehicle instanceof Car car){
                System.out.print("\n[+] Vehicle Details: ");
                System.out.println(car.getClass().getSimpleName() + "[Model=" + car.getModel() + ", Color=" + car.getColor() + ", Seating Capacity=" + car.getSeatingCapacity() + ", Fuel Tank Capacity=" + car.getFuelTankCapacity() + "]");
            }
            if(vehicle instanceof Bike bike){
                System.out.print("\n[+] Vehicle Details: ");
                System.out.println(bike.getClass().getSimpleName() + "[Model=" + bike.getModel() + ", Color=" + bike.getColor() + ", Fuel Tank Capacity=" + bike.getFuelTankCapacity() + "]");
            }
        }
    }
