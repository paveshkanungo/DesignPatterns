...
public class Student {
    ...
    public void printDetails() {
        ...
        System.out.println("Id: " + rollNumber + ", Name: " + name + ", Age: " + age + ", Branch: " + branch + ", Roll No: " + rollNumber +
                ", Father Name: " + fatherName + ", Mother Name: " + motherName + ", Subjects: " + subjects +  ", Mobile No: " + mobileNo +  ", Email Id: " + emailId);
    }
}
